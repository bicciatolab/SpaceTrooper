...
plotPolygons(spe1112, bg_color="white")



# Plot polygons colored by cell area
plotPolygons(spe1112, colour_by="log2AspectRatio")
plotPolygons(spe1112, colour_by="Area_um")

plotPolygons(spe1112, colour_by="flag_score", palette="viridis")
plotPolygons(spe1112, colour_by="is_fscore_outlier")
```
...
plotZoomFovsMap(spe, fovs=c(16:19), colour_by="is_fscore_outlier", 
                useggplot=FALSE)
```
