...
To install the latest version of `SpaceTrooper`, use the following commands. You 
can find other installation options in the README file on the [GitHub repo](https://github.com/drighelli/SpaceTrooper/tree/devel):
